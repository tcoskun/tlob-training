...
class LSTMAnalyzer:
    """LSTM analysis using tensorflow"""
    ...
    def preprocess(self, data_raw, seq_len, train_split, val_split):
        """
    ...
    def numpy_mape(self, y_true, y_pred):
    ...
    def start_analysis(self):
        ...
        project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))  # src klasörünün bir üstü
        ...
        SEQ_LEN = 300
        X_train, y_train, X_val, y_val, X_test, y_test = self.preprocess(scaled_features, SEQ_LEN, train_split = 0.5, val_split = 0.1)
        ...
        if os.path.exists(checkpoint_filepath):
            ...
            best_model = keras.models.load_model(checkpoint_filepath, 
                                                custom_objects={'mean_absolute_percentage_error': self.mean_absolute_percentage_error})
        else:
        ...
        rmse = np.sqrt(mse)
        mape = self.numpy_mape(y_test_last, y_hat_last)
